...
namespace rise.Controllers
{
    ...
    public class LogsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Date,Message")] Log log)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Date,Message")] Log log)
        {
            if (id != log.Id)
            {
                return NotFound();

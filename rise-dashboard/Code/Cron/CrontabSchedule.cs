namespace rise.Code.Cron
{
    ...
    public sealed class CrontabSchedule
    {
        ...
        /// </summary>
        /// <param name="expression">The expression<see cref="string"/></param>
        /// <returns>The <see cref="CrontabSchedule"/></returns>
        ...
        /// <summary>
        /// The GetNextOccurrences
        /// </summary>
        /// <param name="baseTime">The baseTime<see cref="DateTime"/></param>

    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoinQuotes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Payout_address = table.Column<string>(nullable: true),
                    Min_payout = table.Column<double>(nullable: false),
                    Payout_interval = table.Column<int>(nullable: false),
                    Fees_covered = table.Column<bool>(nullable: false),
                    Contact = table.Column<string>(nullable: true),
                    Contact_type = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DelegateForms", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IPData", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IPData_Locations_locationId",
